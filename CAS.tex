...
%\textit{C. micronesica} is endemic to Guam, the Northern Mariana Islands, Yap and Palau were it evolved tolerance to local abiotic threats such as typhoons and drought. 
%
...
The dramatic decline in the Guam \textit{C. micronesica} population is documented by 
a Figure \ref{fig:marler-stem-count} from \cite{marlerLongitudeForestFragmentation2020}. The data come from annual cycad stem counts in 120 permanent plots established after infestation of Guam's wild cycads, but prior to any mortality. It can be seen in the figure that cycad stem count declined to only 12.5\% of the original within the first 3 years of the survey (2005-2008) and continued to decline to only 4\% of the original count in succeeding years (2009-2020). In addition to causing this extremely high plant mortality surviving cycads in the plots have stopped reproducing. The last seedling (0-10 cm tall) was seen in 2006 and the last juvenile (10-100 cm) was seen in 2014.
